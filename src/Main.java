public class Main {
    public static void main(String[] args)
    {
        ...
        double doubleOperandA = 24.6;
        double doubleOperandB = 6.5;
        ...
        System.out.println("the remainder of " + doubleOperandA + " divided by " + doubleOperandB + " is " + doubleModulo );


        // variable
        double myLunchCost = 11.50;
        int numKids = 5;
        ...
        String myFullName = "Kathleen Paige Fitzpatrick";
